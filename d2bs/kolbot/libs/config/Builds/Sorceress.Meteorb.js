/**
 * @desc Sorceress (Meteor + Frozen Orb)
 */
js_strict(true);
...
var AutoBuildTemplate = {
	...
	24: {
		...
		Update: function () {
			...
			Config.AttackSkill = [56, 47, -1, 47, -1, 0, 0]; // Meteor + fire ball
	...
	30: {
		...
		StatPoints: [-1, -1, -1, -1, -1],
		Update: function () {
			Config.AttackSkill = [56, 64, 47, 64, 47, 56, 47]; // Meteor = (56); Frozen Orb (64); Fire Ball (47)
			Config.MPBuffer = 4; // Need lots of mana for Teleport!
