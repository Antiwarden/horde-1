...
function amulet_requirements(mfRun) {
	...
	if (me.getQuest(15, 0) || me.getQuest(10, 0) || (me.getQuest(11, 0)
		&& (me.getItem(521) || me.getItem(91)))) {
			// Skip: Act 3 available, orifice used,
			// or we have completed altar and have
			// amulet or complete staff
...
function amulet(mfRun) {
	...
	if (me.diff === 0) {
		...
		Pather.moveTo(15044, 14045, 3); // Tainted Sun Altar
